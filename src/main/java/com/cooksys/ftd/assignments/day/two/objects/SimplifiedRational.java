...
public class SimplifiedRational implements IRational {
	...
	public static int[] simplify(int numerator, int denominator) throws IllegalArgumentException {
		...
		array[0] = numerator / gcd;
		array[1] = denominator / gcd;
	...
	public SimplifiedRational(int numerator, int denominator) throws IllegalArgumentException {
		...
		if (numerator == 0) {
			...
			int[] array = simplify(numerator, denominator);
			this.numerator = array[0];
			this.denominator = array[1];
		}
	...
	public boolean equals(Object obj) {
		...
		if (obj instanceof SimplifiedRational) {
			SimplifiedRational obj2SRat = ((SimplifiedRational) obj);

			if (obj2SRat.getDenominator() == this.getDenominator() && obj2SRat.getNumerator() == this.getNumerator()) {
				return true;
			}
		}
		...
		// if (obj instanceof SimplifiedRational) {
		// SimplifiedRational obj2SR = (SimplifiedRational) obj;
		//
		// }
	}
